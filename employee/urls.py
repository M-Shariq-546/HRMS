...
urlpatterns = [
    ...
    path('employee-document-tab/', views.employee_document_view, name='employee-document-tab'),
    path(
    ...
    path('resend-documents/<int:document_id>/', views.documenso_document_resend_url, name='resend-documents'),
]
