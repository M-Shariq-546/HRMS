...
from base import announcement, request_and_approve, views , synetect_attendance_work
...
urlpatterns = [
    ...
    path("get-notification-badge", views.get_notification_badge, name="get-notification-badge"),
    path(
    ...
    path('employees-list/', views.employees_active_contract_list, name='employees-list'),
    path('update-company-access-notification-status/', synetect_attendance_work.update_company_notification_access, name='update-company-access-notification-status'),
]
