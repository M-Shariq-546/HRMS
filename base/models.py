...
class Company(HorillaModel):
    ...
    is_notified_access = models.BooleanField(default=False, null=True , blank=True)
    ...
    def get_icon_url(self):
        return FileStorageService.GetImageUrl(self.icon)
    
    def get_icon_url_for_email(self):
        if not self.icon:
            return None
        result = FileStorageService.GetImageUrlForEmail(self.icon)
