...
class Document(HorillaModel):
    ...
    def save(self, *args, **kwargs):
        ...
        if not is_new:
            ...
            old_document = old_instance.document
            
        super().save(*args, **kwargs)
        if not is_new and self.document and self.document != old_document:
            file_url = FileStorageService.UploadImage(self.document, image_type='document')
            if file_url:
                self.document = file_url
                super().save(*args, **kwargs)
    ...
    def get_document_url(self):
        ...
        file_url = file_service.GetImageUrl(self.document)
        return file_url
