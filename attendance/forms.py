...
class NewRequestForm(AttendanceRequestForm):
    ...
    def clean(self) -> Dict[str, Any]:
        ...
        clock_out_time = self.cleaned_data["attendance_clock_out"]
        clock_in_time = self.cleaned_data["attendance_clock_in"]
        
        if clock_out_time and clock_in_time:
            if clock_out_time < clock_in_time:
                raise ValidationError(_("Clock-out time must be after clock-in time.")) 
