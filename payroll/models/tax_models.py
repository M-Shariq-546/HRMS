...
class PayrollSettings(HorillaModel):
    ...
    currency_symbol = models.CharField(null=True, default="PKR (₨)", choices=CURRENCY_SYMBOLS, max_length=15)
    ...
    def currency_code(self):
        return self.currency_symbol.split()[0]
    
    def __str__(self):
        return f"Payroll Settings {self.currency_code}"
...
class TaxBracket(HorillaModel):
    ...
    base_amount = models.FloatField(default=0,null=True, blank=True, verbose_name=_('Base Value'))
