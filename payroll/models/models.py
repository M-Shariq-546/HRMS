...
class Contract(HorillaModel):
    ...
    contract_document = models.FileField(upload_to="contract_documents/", null=True, blank=True)
...
class Allowance(HorillaModel):
    ...
    objects = HorillaCompanyManager()
    is_multiple_allowance = models.BooleanField(default=False, editable=False, verbose_name=_("Recurring Allowance"))
...
class Deduction(HorillaModel):
    ...
    is_multiple_deduction = models.BooleanField(
        default=False,
        verbose_name=_("Recurring Deduction"),
        help_text=_("To specify, the deduction is Recurssive or not"),
    )
