...
urlpatterns = [
    ...
    path(
        "delete-payslip-allowance/<int:payslip_id>/",
        component_views.delete_payslip_allowance,
        name="delete-payslip-allowance",
    ),
    path('delete-payslip-deduction/<int:payslip_id>/', component_views.delete_payslip_deduction, name='delete-payslip-deduction'),
