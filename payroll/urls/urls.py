...
from payroll.views import views, synetec_views
...
urlpatterns = [
    ...
    path(
        'auto-payslip-emails-view/',
        synetec_views.payslipAutomationEmailsView,
        name='auto-payslip-emails-view',
        ),
    path('create-email-automation/', synetec_views.create_or_update_auto_email_payslip, name='create-email-automation'),
    path('update-email-automation/<int:id>/', synetec_views.create_or_update_auto_email_payslip, name='update-email-automation'),
    path(
        "create-auto-payslip",
    ...
    path('email-automation-payslip-update/', synetec_views.activate_auto_email_payslip_generate, name='email-automation-payslip-update'),
    path('delete-auto-email-payslip/<int:id>/', synetec_views.delete_auto_email_payslip, name='delete-auto-email-payslip'),
    path('company-timezone/', synetec_views.company_timezone, name='company-timezone-update'),
    path('get-wise-dashboard-data/', views.get_wise_dashboard_data, name='get-wise-dashboard-data'),
]
