...
class LeaveMailSendThread(Thread):
    ...
    def send_email(self, subject, content, recipients, leave_request_id="#", instance=None):
        host = self.host
            ...
            if recipient:
                html_message = render_to_string(
                    "base/mail_templates/leave_request_template.html",
                    {
                        ...
                        "content": content,
                        "instance": instance,
                        "company_url": instance.employee_id.employee_work_info.company_id.get_icon_url()
                    },
    ...
    def run(self) -> None:
        ...
        if self.type == "request":
            ...
            self.send_email(
                subject_owner, content_owner, [owner], self.leave_request.id, instance
            )
            ...
            self.send_email(subject, content, [owner], self.leave_request.id, instance)
